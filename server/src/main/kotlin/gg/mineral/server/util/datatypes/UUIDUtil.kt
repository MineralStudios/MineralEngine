...
object UUIDUtil {
    ...
    fun fromUUID(uuid: UUID): String = FastUUID.toString(uuid).replace("-", "")

    fun fromString(string: String): UUID = FastUUID.parseUUID(
        string.replaceFirst(
     ...
     */
    fun toIntArray(uuid: UUID): IntArray = intArrayOf(
    ...
    fun fromName(name: String): UUID = UUID.nameUUIDFromBytes(("OfflinePlayer:$name").toByteArray())
}
