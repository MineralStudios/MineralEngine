...
import gg.mineral.server.entity.living.Enderman;
import gg.mineral.server.entity.living.Ghast;
import gg.mineral.server.entity.living.Guardian;
import gg.mineral.server.entity.living.Horse;
import gg.mineral.server.entity.living.HumanEntity;
import gg.mineral.server.entity.living.IronGolem;
import gg.mineral.server.entity.living.Ocelot;
import gg.mineral.server.entity.living.Pig;
import gg.mineral.server.entity.living.Rabbit;
import gg.mineral.server.entity.living.Sheep;
import gg.mineral.server.entity.living.Skeleton;
import gg.mineral.server.entity.living.Slime;
import gg.mineral.server.entity.living.Spider;
import gg.mineral.server.entity.living.Villager;
import gg.mineral.server.entity.living.Witch;
