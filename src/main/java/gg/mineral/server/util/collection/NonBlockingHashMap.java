    ...
    private static final Object get_impl(final NonBlockingHashMap topmap, final Object[] kvs, final Object key,
        ...
        while (true) {
            ...
            if (keyeq(K, key, hashes, idx, fullhash)) {
                ...
                return get_impl(topmap, chm.copy_slot_and_check(topmap, kvs, idx, key), key, fullhash); // Retry in the
                                                                                                        // new table
            }
            ...
            if (++reprobe_cnt >= reprobe_limit(len) || // too many probes
                ...
                return newkvs == null ? null : get_impl(topmap, topmap.help_copy(newkvs), key, fullhash); // Retry in
                                                                                                          // the new
                                                                                                          // table
